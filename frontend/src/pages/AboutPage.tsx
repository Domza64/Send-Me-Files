      ...
      <div className="w-full max-w-2xl space-y-8">
        <div className="text-left space-y-4 mt-10">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            A personal project for file sharing, built with modern technologies.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-300">
            This is my personal project created primarily for my own use, though
            anyone is welcome to use it. I built it to solve my own file sharing
            needs while also creating something substantial for my developer
            portfolio.
          </p>

          <h2 className="text-2xl font-bold text-indigo-400 pt-4">
            Technology Stack
          </h2>
          <p className="text-gray-300">
            The project combines several technologies I wanted to gain
            experience with:
          </p>
          <ul className="text-gray-300 list-disc pl-6 space-y-1">
            ...
            <li>And other supporting technologies...</li>
          </ul>
        ...
        <div className="text-center text-gray-400 text-sm pt-8">
          <p>
            A personal project • Not a commercial product • Built for learning
            and practical use
          </p>
        </div>
      </div>
